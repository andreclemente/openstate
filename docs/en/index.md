...
<div class="os-section" id="why">
  <div class="os-section-inner">
    ...
    <p class="os-section-intro">News are published. People complain. Reports are written. Discussions happen.</p>
...
<div class="os-section" id="how">
  <div class="os-section-inner">
    ...
    <div class="os-chain">
      <div class="os-chain-step"><div class="os-chain-num">1</div><p>Someone documents a real situation</p></div>
      <div class="os-chain-arrow">↓</div>
      <div class="os-chain-step"><div class="os-chain-num">2</div><p>Similar situations are connected</p></div>
      <div class="os-chain-arrow">↓</div>
      <div class="os-chain-step"><div class="os-chain-num">3</div><p>Patterns become visible</p></div>
      <div class="os-chain-arrow">↓</div>
      <div class="os-chain-step os-chain-step-final"><div class="os-chain-num">4</div><p>Knowledge remains</p></div>
    </div>
    <div class="os-cta-row">
      <a href="/en/how-it-works" class="os-btn os-btn-outline">Learn more →</a>
    </div>
  </div>
</div>
...
<div class="os-section" id="observations">
  <div class="os-section-inner">
    ...
    <div id="obs-landing-loading" class="os-obs-loading">Loading…</div>
...
getObservations().then(function(all) {
  ...
  if (latest.length > 0) {
    ...
    for (var i = 0; i < latest.length; i++) {
      ...
      grid.innerHTML += '<a href="/en/observation/?id=' + obs.number + '" class="os-example-card-link">' +
