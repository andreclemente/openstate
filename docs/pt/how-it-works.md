...
Uma observação descreve:

- **O que acontece** — uma sequência factual de eventos
- **Quem é afetado** — cidadãos, empresas, instituições
- **Que evidência a suporta** — notícias, dados, relatórios, legislação, casos reais
...
### 3. Soluções
O que fazer. Propostas estruturadas com estimativa de impacto e evidência de viabilidade.
